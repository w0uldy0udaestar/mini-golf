...
- **시그니처 홀 위주 구성** — 라운드당 **6~9홀이 화면 세로 전체**를 씁니다: 절벽 위 티 ·
  산정 그린 · 대협곡(바닥에 워터) · 계단 대지. 급경사면은 러프라 공이 굴러 내려와 평지에
  서고, 평지 홀은 가끔 나오는 쉬어가는 브리더입니다
...
메뉴바 **⛳️ 좌클릭** = 재개 / 일시정지 · **우클릭** = 메뉴(사운드 · 고대비 모드 · 모니터 · 새 라운드 · 종료)
