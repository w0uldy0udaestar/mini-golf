...
- [x] 2026-08-13 사용자 피드백 8건 반영: 회색 베이스+레드 포인트(스틱맨·깃발), 소프트 라인, 탄도각·수치 어시스트 제거+클럽별 헤드 디자인, 화이트 티 실거리(파36), 러프/페어웨이 랜덤 밴드+라이 물리, 에이프런·그린 도입, 퍼팅 립아웃+퍼터 정밀 입력(선택지 C — 그린 경사는 랜덤 코스 설계 때)
