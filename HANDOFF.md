...
## 현재 상태 (2026-09-24 — v0.8.2 릴리스 뒤 판정 반영: 걸음 속도 상한·티 페그(8754c3f) main 머지. v0.8.3 미배포)
...
1. ~~백로그 4종~~·~~v0.8.2 릴리스~~ 완료. **판정 반영**(8754c3f): "걸음이 어떨 땐 너무 느리다" → 처짐 1.15·험한 길 1.2·합계 상한 1.3 ·
   "티 표현"(사용자 제안) → 티 페그 등장·임팩트에 튕겨 날아감(`teeNode`, 티 박스 첫 샷만). v0.8.3 릴리스는 확인 뒤. 남은 백로그: Apple 공증(Developer 계정 필요) ·
